...
$packages = [
	...
	"lua/Dolos" => [
		...
		"version" => "5.1.1",
		"files" => [
			"Dolos.pluto" => "raw.githubusercontent.com/thebitwise/dolos/5.1.1/Dolos.pluto",
		],
	],
	"lua/Dashmaster" => [
	...
	"lua/BetterChat" => [
		...
		"version" => "1.3.5",
		"files" => [
			"BetterChat.pluto" => "raw.githubusercontent.com/thebitwise/BetterChat/1.3.5/BetterChat.pluto",
		],
		"resources" => [
	...
	"lua/JinxScript" => [
		...
		"version" => "0.48",
		"files" => [
			"JinxScript.pluto" => "raw.githubusercontent.com/Prisuhm/JinxScript/91983eb79f1bfc23de9e55a644653b63fe7ec010/JinxScript.pluto",
		],
	],
	"lua/AcjokerScript" => [
		"priority" => PRIORITY_BLOATWARE,
