...
$packages = [
	...
	"lua/JinxScript" => [
		"priority" => PRIORITY_BLOATWARE,
		"author" => "Prisuhm",
		"description" => "A feature rich script designed to take aim at modders with a handful of unique trolling features and a plethora of useful modder detections.",
		"depends" => [
			"lua/natives-2944a"
		],
		"version" => "0.45",
		"files" => [
			"JinxScript.pluto" => "raw.githubusercontent.com/Prisuhm/JinxScript/23e8f93f16fd2b723a11a8109f08c695399d0ca5/JinxScript.pluto",
		],
	],
	"lua/AcjokerScript" => [
		"priority" => PRIORITY_BLOATWARE,
