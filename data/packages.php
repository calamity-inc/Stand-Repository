...
$packages = [
	...
	"lua/Heist Control" => [
		...
		"files" => [
			"Heist Control.lua" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/Heist Control.lua",
			"store/Heist Control/Language/Chinese.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Chinese.txt",
			"store/Heist Control/Language/Custom.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Custom.txt",
			"store/Heist Control/Language/English.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/English.txt",
			"store/Heist Control/Language/French.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/French.txt",
			"store/Heist Control/Language/German.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/German.txt",
			"store/Heist Control/Language/Italian.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Italian.txt",
			"store/Heist Control/Language/Japanese.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Japanese.txt",
			"store/Heist Control/Language/Korean.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Korean.txt",
			"store/Heist Control/Language/Polish.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Polish.txt",
			"store/Heist Control/Language/Portuguese.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Portuguese.txt",
			"store/Heist Control/Language/Russian.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Russian.txt",
			"store/Heist Control/Language/Spanish.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.2/store/Heist Control/Language/Spanish.txt",
		],
		"resources_version" => "r2",
		"resources" => [
	...
	"lua/AcjokerScript" => [
		...
		"files" => [
			...
			"resources/AcjokerScript/Modules/Vehicles.pluto" => "raw.githubusercontent.com/calamity-inc/AcjokerScript/1288c6d64a64529f75ae0e05c7942cbce1fad9a1/resources/AcjokerScript/Modules/Vehicles.pluto",
