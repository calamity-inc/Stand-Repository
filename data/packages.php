...
$packages = [
	...
	"lua/MusinessBanager" => [
		...
		"version" => "b0a4048",
		"files" => [
			"MusinessBanager.lua" => "raw.githubusercontent.com/calamity-inc/MusinessBanager/b0a4048e627cbfb13919f56c5505ef6792d1ffd4/MusinessBanagersource.lua",
		],
	...
	"lua/Heist Control" => [
		...
		"files" => [
			"Heist Control.lua" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/Heist Control.lua",
			"store/Heist Control/Language/Chinese.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Chinese.txt",
			"store/Heist Control/Language/Custom.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Custom.txt",
			"store/Heist Control/Language/English.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/English.txt",
			"store/Heist Control/Language/French.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/French.txt",
			"store/Heist Control/Language/German.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/German.txt",
			"store/Heist Control/Language/Italian.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Italian.txt",
			"store/Heist Control/Language/Japanese.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Japanese.txt",
			"store/Heist Control/Language/Korean.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Korean.txt",
			"store/Heist Control/Language/Polish.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Polish.txt",
			"store/Heist Control/Language/Portuguese.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Portuguese.txt",
			"store/Heist Control/Language/Russian.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Russian.txt",
			"store/Heist Control/Language/Spanish.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Spanish.txt",
			"store/Heist Control/Language/Vietnamese.txt" => "raw.githubusercontent.com/IceDoomfist/Stand-Heist-Control/v3.4.4/store/Heist Control/Language/Vietnamese.txt",
		],
		"resources_version" => "r2",
		"resources" => [
	...
	"lua/JinxScript" => [
		...
		"version" => "0.52.3",
		"files" => [
			"JinxScript.pluto" => "raw.githubusercontent.com/Prisuhm/JinxScript/b2106e174c1baab1656aacdd0387c425ea477406/JinxScript.pluto",
		],
	],
	"lua/AcjokerScript" => [
		"priority" => PRIORITY_BLOATWARE,
	...
	"lua_compat_layer/2Take1Menu" => [
		...
		"version" => "f2df95b",
		"files" => [
			"lib/2take1 compat.pluto" => "raw.githubusercontent.com/calamity-inc/2take1_lua_loader/f2df95bb06b101fab126f6cd5454d5b9b95190c4/lib/2take1 compat.lua",
		]
	],
	"lua/Ji9sw - Gun Van" => [
		"priority" => PRIORITY_USEFUL_UNPOPULAR,
